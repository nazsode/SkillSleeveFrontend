      ...
      .then((response) => {
        ...
        setTimeout(() => {
          axios
            ...
            .then((res) => {
              setOutput(res.data.stdout || res.data.stderr || 'No output received.');
              setLoading(false);
            })
            .catch((err) => {
              setOutput('Error retrieving result. Please try again.');
              setLoading(false);
            });
        }, 2000);
      })
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 bg-gray-800 p-4 rounded-lg shadow-lg">
          ...
          <div className="terminal mt-6 bg-black text-white p-4 rounded-lg shadow-lg">
            <h4 className="text-sm font-medium text-gray-300">Terminal:</h4>
